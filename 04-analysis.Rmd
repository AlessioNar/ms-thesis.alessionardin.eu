...
that measures the technological diversity range of citing patents.[^1]
...
[^1]: The standard formula for generality is computed as
...
examine also citations of the second degree[^2]. It is important to note
...
classification systems, three based on technological classification[^3],
and two related to industry[^4]. This choice was motivated by the fact
...
[^2]: The citations of a citation

[^3]: The US patent classes, Hall-Jaffe-Trajtenberg technology
    subcategories, and the International Patent Classification

[^4]: Industry of manufacture and Industry of use, based on
...
scenario: WIPO, and USPTO.[^5]

[^5]: World Intellectual Property Organization and United States Patents
...
study for this dissertation is largely based on it[^6]. To overcome the
...
[^6]: A summary of WIPO query strategy can be found in appendix
...
[^7]: The complete code used during the analysis can be found on the
...
to reach more than 5% in 2017[^8]. The timing of this surge in AI
...
[^8]: In appendix [E](#tables){reference-type="ref"
...
[^9]: In figures [1.3](#fig:cpc_gen){reference-type="ref"
...
of forward citations[^10]. It can be observed that, during the period
...
[^10]: Details on the construction of the control sample are provided in
...
with only one forward citation were removed.[^11].

[^11]: Along the lines of previous work by @hall2004uncovering
...
different names but that in the end belonged to the same entity [^12].
...
[^12]: This process is described in detail in appendix
...
patents per year: top 1%, 90%-99%, and lower 89% [^13].
...
differently from the past[^14], this push is coming from private
...
[^14]: Such as the invention and development of the internet, a project
